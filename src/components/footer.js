        ...
        <footer className="xl:max-w-screen-2xl xl:mx-auto mt-20 py-8">
            <div className="m-4 mt-12 md:my-8 md:mx-12 bg-zinc-900 px-6 py-8 md:p-16">
                <div className='flex gap-12 items-stretch'>
                    <h2 className="w-full md:w-1/2 text-zinc-50 text-3xl md:text-4xl leading-none mb-8">Interested? <br /> just <a href="mailto:hi@sajjaddashti.ir" class="underline decoration-red-600"><b>say hi</b></a>.</h2>
                </div>
                <div className="flex-col md:flex-row flex gap-6 md:gap-32 mt-8">
                    ...
                    <div>
                        ...
                        <p className="text-base md:text-lg text-zinc-400 mt-2">hi@sajjaddashti.ir</p>
                    </div>
                    <div>
